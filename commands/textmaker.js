...
async function textmakerCommand(sock, chatId, message, q, type) {
    try {
        ...
        switch (type) {
            case 'metallic':
                 usageErrorText = "Example: .metallic Chris Gaaju";
                break              
            case 'ice':
                usageErrorText = "Example: .ice Chris Gaaju";
                break;
            case 'snow':
                usageErrorText = "Example: .snow Chris Gaaju";
                break;
            case 'impressive':
                usageErrorText = "Example: .impressive Chris Gaaju";
                break;
            case 'matrix':
                usageErrorText = "Example: .matrix Chris Gaaju";
                break;
            case 'light':
                usageErrorText = "Example: .light Chris Gaaju";
                break;
            case 'neon':
                usageErrorText = "Example: .neon Chris Gaaju";
                break;
            case 'devil':
                usageErrorText = "Example: .devil Chris Gaaju";
                break;
            case 'purple':
                usageErrorText = "Example: .purple Chris Gaaju";
                break;
            case 'thunder':
                usageErrorText = "Example: .thunder Gaaju Tech";
                break;
            case 'leaves':
                usageErrorText = "Example: .leaves Gaaju Tech";
                break;
            case '1917':
                usageErrorText = "Example: .1917 Gaaju Tech";
                break;
            case 'arena':
                usageErrorText = "Example: .arena Gaaju Tech";
                break;
            case 'hacker':
                usageErrorText = "Example: .hacker Gaaju Tech";
                break;
            case 'sand':
                usageErrorText = "Example: .sand Gaaju Tech";
                break;
            case 'blackpink':
                usageErrorText = "Example: .blackpink Gaaju Tech";
                break;
            case 'glitch':
                usageErrorText = "Example: .glitch Gaaju Tech";
                break;
            case 'fire':
        ...
        try {
            ...
            await sock.sendMessage(chatId, {
                ...
                caption: "*GENERATED BY Gᴀᴀᴊᴜ-Xᴍᴅ*"
            });
            await sock.sendMessage(chatId, { react: { text: "✅", key: message.key } });
        } catch (error) {
